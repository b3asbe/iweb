...
export const StudentMessageCenter: React.FC = () => {
  const [messages, setMessages] = useState([
    {
      id: '1',
      from: 'María Elena Docente',
      subject: 'Bienvenida',
      content: 'Recuerda revisar el sílabo del curso esta semana.',
      date: '2024-02-01'
    }
  ]);
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-600">
            Comunícate con tus docentes y recibe anuncios importantes
          </p>
        </div>
        <button
